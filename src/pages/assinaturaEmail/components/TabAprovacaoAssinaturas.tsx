...
import ModalReprovarAssinatura from "./componentsAprovacaoAssinaturas/ModalReprovarAssinatura";
import ModalAprovarAssinatura from "./componentsAprovacaoAssinaturas/ModalAprovarAssinatura";
import ModalCreateAssinaturaEmail from "./componentsAprovacaoAssinaturas/ModalCreateAssinaturaEmail";

const TabAprovacaoAssinaturas = ({
  assinaturas,
  totalPages,
  pesquisa,
  setPesquisa,
      ...
      >
        <Grid container spacing={2}>
          ...
          <Grid size={{ xs: 12, md: 3 }}>
            <ModalCreateAssinaturaEmail setFlushHook={setFlushHook} assinaturaPadrao={assinaturaPadrao} />
          </Grid>
        </Grid>
...
export default TabAprovacaoAssinaturas;
