...
const ModalEditarFases = ({ item, showToast, setFlushHook }: any) => {
  ...
  const handleSubmit = async () => {
    try {
      if (validateForm()) {
        ...
        setFlushHook((prev: any) => !prev); // Atualiza o estado de flush
      }
    } catch (error) {
      console.log(error);
      showToast("Erro ao editar Fase!", "error");
    }
  };
...
export default ModalEditarFases;
